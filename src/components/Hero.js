    ...
    return (
      <Flex
        ...
        //   px={useBreakpointValue({ base: 4, md: 8 })}
          ...
          <Flex width={"96vw"} height="80vh" justify="center" flexDirection={"column"} >
            <Stack direction={'row'} alignSelf="flex-start" >
            <Image src={isDesktop ? logoWeb : logoMob }  />
            
            </Stack>
            
            <Stack direction={'row'} alignSelf="flex-end" mt={isDesktop ?  "30px" : "80px"} marginEnd={isDesktop ? "50px": 0}>
            <Image src={isDesktop ? logo4Web : logo4Mob }  />
            
            </Stack>
      
            <Stack direction={'row'} background="white" justify={"center"} width={isDesktop ? "50vw": "100vw"} mt={isDesktop ?  "30px" : "80px"}>
